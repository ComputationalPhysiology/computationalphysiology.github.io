...
Here is a list of recent publications from the Computational Physiology Department at Simula Research Laboratory. Some of the publications have associated code repositories that can be found by following the links in the titles.
...
- [fenicsx-beat-An Open Source Simulation Framework for Cardiac Electrophysiology](https://github.com/finsberg/fenicsx-beat) {cite}`finsberg2025fenicsx`
- Insights from electromechanical simulations to assess omecamtiv mecarbil efficacy in heart failure {cite}`10.1113/JP288233`
